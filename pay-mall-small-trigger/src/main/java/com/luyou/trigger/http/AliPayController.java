...
import com.luyou.api.IPayService;
...
import com.luyou.types.common.Constants;
...
public class AliPayController implements IPayService {
     ...
     * }
     */
    @RequestMapping(value = "create_pay_order", method = RequestMethod.POST, consumes = { "application/json", "application/xml" })
    @Override
